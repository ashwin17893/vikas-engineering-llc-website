...
export default function EngineeringServices() {
  ...
  return (
    <div>
      ...
      <ContactModal show={showContact} onHide={() => setShowContact(false)} initialMessage={"I'm interested in your engineering services."} />
      ...
      <header className="about-hero py-5" style={{ position: 'relative', color: '#fff' }}>
        ...
        <Container style={{ position: 'relative', zIndex: 1 }}>
          <Row className="justify-content-center text-center py-5">
            <Col md={8}>
              <h1 className="display-5 fw-bold">Engineering Services</h1>
              <p className="lead">Coming soon — professional engineering support for pipelines and infrastructure.</p>
              <Button variant="warning" onClick={() => setShowContact(true)}>Request a Quote</Button>
            </Col>
          </Row>
        </Container>
      </header>
