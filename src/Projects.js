...
export default function Projects() {
  ...
  return (
    <div>
      ...
      <ContactModal show={showContact} onHide={() => setShowContact(false)} initialMessage={"I'm interested in your project experience and gallery."} />
        ...
        <Container style={{ position: 'relative', zIndex: 1 }}>
          <Row className="justify-content-center text-center py-5">
            <Col md={8}>
              ...
              <p className="lead">Project artifacts and photo gallery coming soon.</p>
